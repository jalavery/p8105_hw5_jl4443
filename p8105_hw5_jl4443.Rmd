...
We can see from the below figure that as the effect size increases, power also increases. 
...
The average estimated effect size is larger among significant results when the true effect size is smaller because the 
```{r}
